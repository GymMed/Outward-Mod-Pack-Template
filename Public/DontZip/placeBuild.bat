...
:: Source paths
set "sourceDll=C:\Users\pc\source\repos\OutwardModPackTemplate\Release\OutwardModPackTemplate.dll"
...
if exist "%sourceDll%" (
    for %%p in (%profiles%) do (
        set "destinationDll=%baseProfilePath%\%%~p\BepInEx\plugins\myname-OutwardModPackTemplate"
